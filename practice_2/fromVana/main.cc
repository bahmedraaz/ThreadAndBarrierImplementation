...
//This is the macro used for testing. For testing, we need to dfine 
...
void *maxFinder(void *arg){
	...
	//cout<<"Entering Thread: "<<id<<" round: "<<roundNumber<<endl; //for debugging
	barrierObj.wait();
	//cout<<"Exiting Thread: "<<id<<" round: "<<roundNumber<<endl; //for debugging

	maxFinder((void *)&newThreadInfo);
	
	

	//cout<<"hello bulbul"<<endl; //for debugging
	pthread_exit(0);
...
// ******** Testing ********
// for testing, comment out the first block and use the 
//second block to get input from file
...
// ******** End of Testing ********
	...
	cout<<userInput[resultEntryPositionUserInput-1]<<endl; //print the maximum number
}
